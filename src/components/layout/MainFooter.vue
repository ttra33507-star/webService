  ...
  <footer class="bg-gradient-to-br from-[#e8f4fb] via-white to-white py-14">
    <div class="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
      <div class="text-center">
        <p class="text-3xl font-semibold uppercase p-3 text-[#0c86c3]">Legal Information</p>
      </div>
      <div class="grid gap-6 md:grid-cols-3">
        <article
          v-for="card in legalCards"
          :key="card.label"
          class="group rounded-[2rem] border border-[#0c86c3]/25 bg-white/90 p-6 text-center shadow-[0_25px_80px_rgba(6,22,45,0.08)] transition hover:-translate-y-1 hover:border-[#0c86c3]/50 hover:shadow-[0_30px_90px_rgba(6,22,45,0.15)]"
        >
          <span
            class="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-[#d6ecfb] text-[#0c86c3] transition group-hover:bg-[#0fa6ef]/15"
          >
            <svg
              class="h-6 w-6"
              viewBox="0 0 24 24"
          ...
          <p class="mt-4 text-lg font-semibold text-slate-900">{{ card.label }}</p>
